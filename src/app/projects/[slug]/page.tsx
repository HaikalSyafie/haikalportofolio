...
function ImagePlaceholder({ label, caption }: { label: string; caption: string }) {
  return (
    <div className="my-6">
      ...
      <p className="text-xs text-subtle mt-2 text-center italic">{caption}</p>
    </div>
  );
}
...
export default async function ProjectPage({
  ...
  const sectionImageKeys = ["eda", "evaluation", "results"];
  ...
  return (
    <div className="pb-16 sm:pb-20">
      ...
      <div className="section-container max-w-3xl">
        ...
        <Reveal as="div" className="py-8 border-t border-border">
          ...
          <div className="mt-5 rounded-lg border border-border bg-surface px-4 py-3.5">
            ...
            <p className="mt-1 text-sm text-foreground-muted">{project.role}</p>
          </div>
        </Reveal>
        ...
        <Reveal as="div" className="py-8 border-t border-border">
          ...
          <div className="mt-8 space-y-7">
            ...
            <MethodStep label="Exploratory Data Analysis">
              <p>{project.eda}</p>
              {imageMap.eda && (
                <ImagePlaceholder label={imageMap.eda.alt} caption={imageMap.eda.caption} />
              )}
            </MethodStep>
            ...
            <MethodStep label="Evaluation Methodology">
              ...
              {imageMap.evaluation && (
                <ImagePlaceholder label={imageMap.evaluation.alt} caption={imageMap.evaluation.caption} />
              )}
            </MethodStep>
          </div>
        </Reveal>
        ...
        <Reveal as="div" className="py-8 border-t border-border">
          ...
          {imageMap.results && (
            <ImagePlaceholder label={imageMap.results.alt} caption={imageMap.results.caption} />
          )}
        ...
        <Reveal as="div" className="py-8 border-t border-border">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md text-sm font-medium hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
      ...
      {/* ============================================================ */}
      <div className="section-container max-w-3xl mt-2">
